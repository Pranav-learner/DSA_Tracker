...
/** A titled analytics block — icon + title + optional action over its content. */
export function AnalyticsSection({ title, description, icon, action, children, className, id }: AnalyticsSectionProps) {
  return (
