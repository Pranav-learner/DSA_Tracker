...
export const SLASH_COMMANDS: SlashCommandMeta[] = [
  { command: 'study', intent: 'study-plan', profiles: ['learning', 'gamification', 'revision'], label: 'Study planning', description: 'Plan what to study next from your roadmap' },
  { command: 'revision', intent: 'revision', profiles: ['revision', 'learning'], label: 'Revision help', description: 'Work through your revision backlog' },
  { command: 'contest', intent: 'contest', profiles: ['contest', 'gamification'], label: 'Contest prep', description: 'Prepare for your next rated contest' },
  { command: 'notebook', intent: 'notebook', profiles: ['knowledge'], label: 'Notebook & patterns', description: 'Explore your pattern notebook' },
  { command: 'analytics', intent: 'analytics', profiles: ['analytics', 'gamification'], label: 'Analytics insight', description: 'Understand your strengths and weak spots' },
  { command: 'interview', intent: 'interview', profiles: ['gamification', 'knowledge', 'learning'], label: 'Interview prep', description: 'Get ready for coding interviews' },
  { command: 'help', intent: 'general', profiles: ['learning', 'conversation'], label: 'Help', description: 'What can the mentor do?' },
];
